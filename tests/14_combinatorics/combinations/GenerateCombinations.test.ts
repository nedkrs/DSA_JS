import GenerateCombinations from "../../../src/14_combinatorics/combinations/GenerateCombinations";
...
describe("GenerateCombinations", () => {
    ...
    test("array = [1, 2, 3, 4], size = 3", () => {
        expect(GenerateCombinations([1, 2, 3, 4], 3)).toEqual(
            expect.arrayContaining([
                [1, 2, 3],
                [1, 2, 4],
                [1, 3, 4],
    ...
    test("array with duplicate elements, size = 2", () => {
        expect(GenerateCombinations([1, 2, 2], 2)).toEqual(
            expect.arrayContaining([
                [1, 2],
                [1, 2],
                [2, 2],
    ...
    test("array = [1, 2, 3, 4, 5], size = 4", () => {
        expect(GenerateCombinations([1, 2, 3, 4, 5], 4)).toEqual(
            expect.arrayContaining([
                [1, 2, 3, 4],
                [1, 2, 3, 5],
                [1, 2, 4, 5],

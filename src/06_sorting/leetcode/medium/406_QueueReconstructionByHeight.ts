...
// Each people[i] = [hi, ki] represents the ith person of height hi with exactly ki other people in
...
// Medium: https://leetcode.com/problems/queue-reconstruction-by-height/description/
